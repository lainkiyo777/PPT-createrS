# Slide 14 prompt — template-preserving beautification

- **Reference image:** `../reference-slides/source-slide-14.png`
...
Use the attached reference image source-slide-14.png as the primary template and composition reference.
...
Closing slide. Preserve the teal top band, centered 汇报完毕，谢谢！ message, the Huaneng logo and the original red/blue curved accent near the bottom. Improve centering and optical balance only. Do not add contact details, QR codes, slogans or extra decoration.
