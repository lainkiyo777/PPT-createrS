# Slide 10 prompt — template-preserving beautification

- **Reference image:** `../reference-slides/source-slide-10.png`
...
Use the attached reference image source-slide-10.png as the primary template and composition reference.
...
Results and innovation slide. Keep the five outcome cards across the top and the four numbered innovation cards below. Preserve all counts (1套、2个、10项、2项、1项、4类) and the four innovation descriptions. Improve card hierarchy, whitespace and red numbered accents; do not turn the page into a new diagram or add benefits not present in the source.
